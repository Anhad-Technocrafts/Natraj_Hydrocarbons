...
const Header2 = () => {
  ...
  return (
    <>
      <header
        className={`cs_site_header cs_style_1 cs_color_1 header2 cs_sticky_header ${isSticky ? isSticky : ""
          }`}
      >
          ...
          <div className="container">
            <div className="cs_main_header_in">
              <div className="cs_main_header_left">
                <Link className="cs_site_branding" style={{ overflow: 'hidden', borderRadius: '20px' }} to={data.logoUrl}>
